/**
 * Area Abbotsford Page Accessibility — DURABLE SPEC
 *
 * This file provides permanent light + dark axe coverage for the /areas/abbotsford page.
 * The page is dev-hidden (noindex) but reachable in dev — no redirect (D-02).
 * Tests run against the dev server.
 *
 * Tests:
 *   1. Light mode — page.goto('/areas/abbotsford') with system default context; zero axe violations.
...
test.describe('Area Abbotsford Page Accessibility', () => {
  test('Area Abbotsford page in light mode should not have accessibility violations', async ({ page }) => {
    await page.goto('/areas/abbotsford');
  ...
  test('Area Abbotsford page in dark mode should not have accessibility violations', async ({ browser }) => {
