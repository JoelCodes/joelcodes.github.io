...
**Phase 26 Variant Evidence outcome:** 17 rows total (Section/CTA: 8 rows including ref descendant + sibling note + body width annotation; Section/NavBack: 9 rows including 4 link text nodes + sibling note). Per OPEN-23-13 dual-track: all literal hex/size/typography values appear here bound to their semantic alias counterparts; downstream consumers (Phase 26-01 FAQ + 26-02 404 + Phase 31 Homepage) instance these section components without redrawing.
