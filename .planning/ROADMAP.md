...
- [x] 38-01-PLAN.md — Extract frame 12:3 + build dev-gated /showcase (page, projects.json, nav gate, sitemap) [PAGE-02]
- [x] 38-02-PLAN.md — Draft blog Figma frames (index+post @1440/390, light-only) via use_figma [PAGE-06]

**Wave 2** (parallel — showcase verify + blog frame approval)

- [x] 38-03-PLAN.md — Showcase axe + contrast + fidelity gate (frame 12:3) [checkpoint] [PAGE-02]
- [x] 38-04-PLAN.md — HARD CHECKPOINT: Joel approves blog frames (gates all blog build) [checkpoint] [PAGE-06]

**Wave 3** (blog build foundations — depends on frame approval)

- [x] 38-05-PLAN.md — .wl-prose scope + expressive-code retheme + wl/BlogCard component [PAGE-06]
...
- [x] 39-04-PLAN.md — Extract 85:103/85:104 + build /services/web + /areas/abbotsford (noindex head-slot, ProfessionalService JSON-LD, wl/ composition, NO PROD redirect) + axe specs + contrast pairs [PAGE-03, PAGE-04, IA-02]

**Wave 4** (verification + fidelity gate)

- [x] 39-05-PLAN.md — Verification gate (build + sitemap/JSON-LD/noindex grep + a11y) + fidelity screenshots + Joel approval [checkpoint] [PAGE-03, PAGE-04, PAGE-05, IA-02]
...
*Last updated: 2026-07-20 — Phase 39 executed (5/5 plans); roadmap restored after Phase-39 planning truncation*
