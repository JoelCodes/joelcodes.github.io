...
- No new violations on Homepage (including Hero section)
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>
Complete component migration across Contact page, Portfolio pages, Blog pages, Homepage ContactSection, and Hero section.
...
5. Visit homepage (http://localhost:4321/)
   - Scroll to contact section, verify textarea matches other inputs
   - Check Hero section badge element has proper styling and shadow
...
- [ ] Hero section badge displays correctly
